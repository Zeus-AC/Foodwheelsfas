  ...
  final notificationList = [
    {
      ...
      "list": [
        {
          "title": "Your Food has ben Delivered",
          "message": "Hurrey! Your Food has been delivered.Enjoy your Food.",
          "isFoodNotification": true
        },
        {
          "title": "Rate the Restaurant!",
          "message": "Please rate the restaurant to improve our services!",
    ...
    },
    {
      ...
      "list": [
        ...
        },
        {
          ...
          "message":
              "Hurrey! Your Food has been delivered in short time. Enjoy your Food.",
          "isFoodNotification": true
        },
        {
          "title": "Thank You for ordering...",
          "message":
              "Thanks for ordering food using this app. Have a nice day.",
          "isFoodNotification": true
        },
        {
          "title": "Payment Failed!...",
          "message":
              "Oops! something went wrong your payment has been failed... ",
          "isFoodNotification": true
        },
      ]
    }
