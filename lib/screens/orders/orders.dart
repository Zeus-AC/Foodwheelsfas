...
class _OrdersScreenState extends State<OrdersScreen> {
  final tabBarList = ["Ongoing", "History"];
            ...
            Expanded(
              child: Stack(
                children: [
                  ...
                  if (itemData['status'] == "Preparing")
                    statusBox("Preparing", orangeColor),
                  if (itemData['status'] == "Dispatch")
                    statusBox("Dispatch", primaryColor),
                  if (itemData['status'] == "Ordered")
                    statusBox("Dispatch", greyColor)
                ],
              ),
            )
          ],
