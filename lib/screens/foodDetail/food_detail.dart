...
class _FoodDetailScreenState extends State<FoodDetailScreen> {
  ...
  final sizeList = ["Small", "Medium", "Large", "Extra Large"];
  int selectedSize = 1;

  final optionList = [
    {"title": "Extra Cheese", "isSelected": false},
    {"title": "Extra Mayonnaise", "isSelected": true},
    {"title": "Extra Veggies", "isSelected": false},
  ];
  ...
  Widget foodInfo() {
    return Column(
      ...
      children: [
        ...
        heightSpace,
        const Text(
          "These ingredients include red tomato sauce, white mozzarella and fresh green basil.",
          style: medium16Grey,
        ),
        heightSpace,
        Row(
