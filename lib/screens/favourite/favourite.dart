...
class _FavouriteScreenState extends State<FavouriteScreen> {
  final tabBarList = ["Foods", "Restaurants"];
  ...
  final favouriteRestaurantList = [
    ...
    },
    {
      ...
      "name": "Bar61 Restaurant",
      "address": "220 Opera Street, England",
      "rate": 4.0,
      "review": 100,
    },
  ];
            ...
            child: PageView(
              ...
              children: [
                favouriteFoodList.isEmpty
                    ? emptyListContent("No Item in Favourite Foods")
                    : foodFavouriteListContent(size),
                favouriteRestaurantList.isEmpty
                    ? emptyListContent("No Item in Favourite Restaurant ")
